...
export default function PrivacyPolicyPage() {
  return (
    <LegalPageLayout
      ...
      intro="Phoenix Hotels & Resorts"
      sections={[
        {
          heading: "Your Privacy Matters to Us",
          paragraphs: [
            "Your privacy plays an important role for Phoenix Hotels & Resorts. We believe that our customers have the right to understand the privacy policy we follow. Phoenix Hotels & Resorts recognizes the importance of the information that is collected, used, disclosed, and stored.",
